...
CREATE TABLE `brand` (
  ...
  `coreProduct` varchar(500) DEFAULT NULL COMMENT 'Core product/service',
  `coreProductDetail` text COMMENT 'Core product detailed description',
  `targetAudience` varchar(500) DEFAULT NULL COMMENT 'Target audience',
  `targetAudienceDetail` text COMMENT 'Target audience detailed description',
  `mainColor` varchar(50) DEFAULT NULL COMMENT 'Main theme color for content',
  `selectedContentTypes` json DEFAULT NULL COMMENT 'Selected content types for this brand',
  `brandAnalysis` text COMMENT 'AI-generated brand analysis summary',
  PRIMARY KEY (`id`),
