...
-- This will delete all projects, content, and brands for this specific user

-- First, disable foreign key checks to avoid constraint errors
SET FOREIGN_KEY_CHECKS = 0;

-- Get all project IDs for user 27
SELECT GROUP_CONCAT(id) as project_ids FROM project WHERE fk_userId = 27;
...
-- Delete regenerate logs for user 27's projects
...
-- Delete brands created by user 27 (if they own any)
...
SELECT 'User 27 - Projects deleted:' as 'Status', ROW_COUNT() as 'Count'
UNION ALL
SELECT 'User 27 - Remaining projects:', COUNT(*) FROM project WHERE fk_userId = 27
UNION ALL
